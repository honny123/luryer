					...
					<div class="reg_field_user">
						<div class="main_item">
							...
							<?php }else if($result == 1){ ?>
								...
								<ul class="ipt_list">
									<li class='reg_pwd'><label for='pwd'>登录密码:</label><input type='password' name='pwd' id='pwd' maxlength='16'/><span class='reg_tip'></span><div class='pwd_save'></div></li>
									<li class='reg_re_pwd'><label for='re_pwd'>确认密码:</label><input type='password' name='re_pwd' id='re_pwd' maxlength='16'/><span class='reg_tip'></span></li>
								</ul>
								<div class="reg_submit">
									<input type="submit" class="register_btn step2_next" data-mail='<?php echo $mail; ?>' data-code='<?php echo $code; ?>' value="下一步"/>
								</div>
							<?php } ?>
						</div>
					</div>
