      ...
      <!-- header -->
            ...
            <div id="contentwrapper">
                ...
                <li><a href="<?php echo site_url('admin/article'); ?>">内容管理</a></li>                               
                  ...
                  <div class="row-fluid">
            <div class="span12">
              <h3 class="heading">添加帖子</h3>
              <form class="form-add-article" action="<?=site_url('admin/article/post');?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" name="article-form">
                <div class="formSep">
                  <div class="row-fluid">
                    <div class="span8">
                      <div class="row-fluid">
                        <div class="span8">
                          ...
                          <input type="text" name="title" class="span12" value=""/>
                        </div>
                        <div class="span2">
                      ...
                      <div class="row-fluid">
                        <div class="span12">
                          ...
                          <div data-fileupload="image" class="fileupload fileupload-new">
                            ...
                            <div>
                              <span class="btn btn-file"><span class="fileupload-new">选择</span><span class="fileupload-exists">修改</span><input type="file" name="picture"></span>
                  ...
                  <div class="row-fluid">
                    <div class="span12">
                      <label>内容 </label>
                      <textarea type="text" name="content" class="span12"></textarea>
                    </div>
                  </div>
                </div>
