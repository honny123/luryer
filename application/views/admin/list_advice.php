...
<html lang="en">
              ...
              <table class="table table-bordered table-striped" id="smpl_tbl">
                ...
                <tbody>
                  <?php foreach ($advices as $advice) {?>
                    <tr>
                      <td><input type="checkbox" name="row_sel" class="select_row" value="<?php echo $advice->advice_id; ?>" /></td>
                      <td><?php echo $advice->advice_id; ?></td>
                      <td><?php echo $advice->advicer; ?></td>
                      <td><?php echo $advice->advice_email; ?></td>
                      <td><?php echo $advice->advice_phone; ?></td>
                      <td><?php echo $advice->advice_date; ?></td>
                      <td>
                        <a href="../admin/advice/view/<?php echo $advice->advice_id; ?>" class="sepV_a" title="View"><i class="icon-eye-open"></i></a>
                      <!-- <a href="javascript:;" class="delete_row" data-aid="<?php echo $advice->advice_id; ?>"><i class="icon-trash"></i></a> -->
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
    ...
    <!-- 页面级css -->
    <script src="<?php echo site_url('assets/admin/js/list_advice.js'); ?>"></script>
    <script>
