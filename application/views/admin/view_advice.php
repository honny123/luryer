    ...
    <div id="maincontainer" class="clearfix">
      <!-- header -->
            ...
            <div id="contentwrapper">
                ...
                <li><a href="<?php echo site_url('admin/advice'); ?>">意见管理</a></li>                               
                                <li>查看意见</li>
                            </ul>
                        </div>
                    </nav>
              ...
              <div class="row-fluid">
                <div class="span12">
                  <div class="vcard">
                    <ul>
                      <li>
                        <span class="item-key">意见人</span>
                        <div class="vcard-item"><?php echo $advice -> advicer;?></div>
                      </li>
                      <li>
                        <span class="item-key">邮箱</span>
                        <div class="vcard-item"><?php echo $advice -> advice_email;?></div>
                      </li>
                      <li>
                        <span class="item-key">电话</span>
                        <div class="vcard-item"><?php echo $advice -> advice_phone;?></div>
                      </li>
                      <li>
                        <span class="item-key">日期</span>
                        <div class="vcard-item"><?php echo $advice -> advice_date;?></div>
                      </li>
                      <li>
                        <span class="item-key">内容</span>
                        <div class="vcard-item"><?php echo $advice -> advice_content;?></div>
                      </li>
                    </ul>
                  </div>
                </div>
