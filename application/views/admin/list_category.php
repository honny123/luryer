...
<html lang="en">
    ...
    <body>
						...
						<div class="span12">
							...
							<div class="btn-group sepH_b">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="<?php echo site_url('admin/category/add'); ?>" class="add-article"><i class="icon-plus"></i>添加种类</a></li>
								</ul>
							</div>
							<table class="table table-bordered table-striped" id="smpl_tbl">
								...
								<tbody>
									<?php foreach ($rows as $row) {?>
										<tr>
											<td><input type="checkbox" name="row_sel" class="select_row" value="<?php echo $row->category_id; ?>" /></td>
											<td><?php echo $row->category_id; ?></td>
											<td><?php echo $row->category_title; ?></td>
											<td><?php echo $row->category_belong; ?></td>
											<td><a href="<?php echo site_url('admin/category/edit/'.$row->category_id); ?>" class="sepV_a" title="Edit"><i class="icon-pencil"></i></a>
											<a href="javascript:;" class="delete_row" data-aid="<?php echo $row->category_id; ?>"><i class="icon-trash"></i></a></td>
										</tr>
									<?php } ?>
								</tbody>
							</table>
		...
		<!-- ҳ�漶css -->
		<script src="<?php echo site_url('assets/admin/js/list_category.js'); ?>"></script>
		<script>
