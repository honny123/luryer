						...
						<div class="span12">
							...
							<form class="form-add-user" action="<?=site_url('admin/category/post');?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" name="user-form">
									...
									<div class="row-fluid">
										<div class="col-md-4 col-md-offset-4">
  												...
  												<div class="form-group" style="padding-left: 150px;">
    												...
    												<input type="text" class="form-control" name="catename" placeholder="" value="<?php echo $cate->category_title; ?>">
  												</div>
  												<div class="form-group" style="padding-left: 150px;">
    												<label for="exampleInputPassword1">所属种类</label>
    												<select name="type_id">
    													<option value="0" <?php echo $cate->relate_id == 0?"selected":"" ?>selected>一级种类</option>
														<?php foreach ($cates as $ct) { ?>
															<option value="<?php echo $ct -> category_id;?>" <?php echo $cate->relate_id==$ct -> category_id?"selected":""?>><?php echo $ct -> category_title;?></option>
														<?php } ?>
													</select>
  												</div>
										</div>
								...
								<div class="form-actions" style="padding-left: 150px;">
									<input type="hidden" name="cateId" value="<?php echo $cate -> category_id;?>"/>
