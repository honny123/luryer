/* [ ---- Gebo Admin Panel - tables ---- ] */
                    ...
                    $.colorbox({
                        ...
                        onComplete: function(){
                            $('.confirm_yes').click(function(e){
                                ...
                                $.get("../admin/article/remove", {articleIds:aNews}, function(data){
        ...
        $.colorbox({
                    ...
                    onComplete: function(){
                        $('.confirm_yes').click(function(e){
                            ...
                            $.get("../admin/article/remove", {articleIds:newsId}, function(data){
                              if(data == "success"){
  ...
  gebo_edit_row = {
    ...
    post: function(){
      ...
      if(cateId){
          $.get("/admin/category/edit/"+cateId, function(data){
             if(data == "success"){
